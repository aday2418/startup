...
export default function ErrorMessage(){
    ...
    return(
        <div className='flex flex-col items-center justify-center gap-3'>
            ...
            {urlMessage == "login" && <h1 className='flex items-center justify-center text-black-500 font-semibold'>If You Are Having Trouble Getting Authenticated By Spotify, Check The Github Link For a Spotify Username + Password That You Can Use</h1>}
