...
export default function FriendGrid({friends, removeFriend}){ 
    return(
        <div>
            ...
            <p className="font-bold"> The grey/green circle next to the Profile Picture indicates whether or not a user is currently signed into their account (WebSocket Data)</p>
